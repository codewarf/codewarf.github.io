...
| `font-family`    | 글꼴 패밀리를 지정                              | `font-family: Arial, sans-serif;`|
...
| `z-index`        | 요소의 쌓임 순서를 지정                         | `z-index: 100;`                 |
...
| `clip-path`         | 요소를 특정 모양으로 클리핑(ex 잘라내기)            | `clip-path: circle(50%);`       |
...
| `counter-reset`     | CSS 카운터를 초기화                           | `counter-reset: section;`       |
| `counter-increment` | CSS 카운터를 증가시킴                           | `counter-increment: section 1;` |
...
| 속성                 | 설명                                                | 예시                             |
|----------------------|---------------------------------------------------|----------------------------------|
| `float`             | 요소를 왼쪽 또는 오른쪽으로 띄움(Z축으로 띄운다는 느낌)   | `float: right;`                 |
...
| `box-shadow`         | 요소에 그림자를 추가                          | `box-shadow: 2px 2px 5px gray;` |
| `text-shadow`        | 텍스트에 그림자를 추가                         | `text-shadow: 1px 1px 3px black;` |
...
| 속성                 | 설명                                                | 예시                             |
|----------------------|---------------------------------------------------|----------------------------------|
| `inherit`           | 부모 요소의 값을 상속받음                       | `color: inherit;`               |
| `initial`           | 기본 값으로 리셋                              | `display: initial;`             |
| `unset`             | 상속 가능한 속성은 상속, 나머지는 초기화         | `all: unset;`                   |
